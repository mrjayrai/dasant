  ...
  const serviceprovided = [
    {
      ...
      image: postcard,
      feature:[
        {id:'41',title:'Feature Films',dec:'We develop and produce quality, engaging feature films that captivate audiences. Telling memorable stories, and leave a lasting impact. From script to screen, our team collaborates with writers, directors, and producers to bring unique visions and ideas to life in a cinematic experience.',image:bg10},
        {id:'42',title:'Short Films',dec:'We create engaging and concise short films that tell powerful stories, evoke emotions, and leave a lasting impression. From script to screen, our team helps you develop and produce high-quality atristics short films that showcase your vision, talent, and creativity.',image:bg5},
        {id:'43',title:'Documentaries',dec:'We craft compelling, informative, and engaging documentary films that tell real stories. We explore important issues, and showcase unique perspectives. Our team helps you bring your vision to life, from research to editing, and creates high-quality documentaries that educate, inspire, and leave a lasting impact',image:bg3},
    ...
    },
    {
      ...
      feature:[
        {id:'21',title:'TV Commercials',dec:'We produce top-notch quality, engaging TV ads that capture viewers attention, build brand awareness, and drive sales. From concept to broadcast, we help you create compelling stories. We showcase your products in greeting way, and reach your target audience through effective television advertising',image:bg14},
        {id:'22',title:'Online Video Ads',dec:'Our team produces and delivers max-impact video ads that engage viewers, communicate your message, and achieve your marketing objectives. We expertly manage your video ad campaigns to maximize reach, views, and ROI.',image:bg7},
    ...
    },
    {
      ...
      feature:[
        ...
        {id:'13',title:'Sound Design',dec:'We craft and shape the sonic landscape of your visual content, creating an immersive audio experience that complements and enhances the narrative. Our team delivers high-quality sound effects, Foley, and mixing services to bring your project to life',image:sound},

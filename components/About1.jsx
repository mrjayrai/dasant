...
export default function About1() {
  return (
    <>
    <div className='block'>
    <div className='bg-gray900  text-PrimaryBlack flex justify-center items-center text-center text-[38px] font-bold leading-[50px] px-[230px] py-[20px] font-montserrat '>

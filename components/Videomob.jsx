...
export default function Videomob() {
  return (
    <div className='bg-neutralSilver relative z-9999 mt-[24px] sm:hidden' style={{ transformStyle: 'preserve-3d', WebkitTransformStyle: 'preserve-3d' }}>
      <div className=' pt-16 relative w-full top-0 '> {/* Changed to h-screen for full height */}
